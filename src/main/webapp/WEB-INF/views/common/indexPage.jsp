...
<head>
    ...
    <link href="<%=request.getContextPath()%>/resources/vendor/jqvmap/css/jqvmap.min.css" rel="stylesheet">
	<link rel="stylesheet" href="<%=request.getContextPath()%>/resources/vendor/chartist/css/chartist.min.css">
    <link href="<%=request.getContextPath()%>/resources/vendor/bootstrap-select/dist/css/bootstrap-select.min.css" rel="stylesheet">
	<link href="<%=request.getContextPath()%>/resources/vendor/bootstrap-datetimepicker/css/bootstrap-datetimepicker.min.css" rel="stylesheet">
        ...
        ***********************************-->
        <div class="nav-header" style="background-color: #333258">
            <a href="index" class="brand-logo">
                ...
                <img class="logo-compact" src="<%=request.getContextPath()%>/resources/images/logo-text.png" alt="">
								...
								<ul class="contacts">
									...
									<li class="active dz-chat-user">
										<div class="d-flex bd-highlight">
											<div class="img_cont">
												<img src="<%=request.getContextPath()%>/resources/images/avatar/1.jpg" class="rounded-circle user_img" alt=""/>
									...
									<li class="dz-chat-user">
										<div class="d-flex bd-highlight">
											<div class="img_cont">
												<img src="<%=request.getContextPath()%>/resources/images/avatar/2.jpg" class="rounded-circle user_img" alt=""/>
									...
									<li class="dz-chat-user">
										<div class="d-flex bd-highlight">
											<div class="img_cont">
												<img src="<%=request.getContextPath()%>/resources/images/avatar/3.jpg" class="rounded-circle user_img" alt=""/>
												<span class="online_icon"></span>
											</div>
											<div class="user_info">
									...
									<li class="dz-chat-user">
										<div class="d-flex bd-highlight">
											<div class="img_cont">
												<img src="<%=request.getContextPath()%>/resources/images/avatar/4.jpg" class="rounded-circle user_img" alt=""/>
												<span class="online_icon offline"></span>
											</div>
											<div class="user_info">
									...
									<li class="dz-chat-user">
										<div class="d-flex bd-highlight">
											<div class="img_cont">
												<img src="<%=request.getContextPath()%>/resources/images/avatar/5.jpg" class="rounded-circle user_img" alt=""/>
												<span class="online_icon offline"></span>
											</div>
											<div class="user_info">
							...
							<div class="card-body msg_card_body dz-scroll" id="DZ_W_Contacts_Body3">
								<div class="d-flex justify-content-start mb-4">
									<div class="img_cont_msg">
										<img src="<%=request.getContextPath()%>/resources/images/avatar/1.jpg" class="rounded-circle user_img_msg" alt=""/>
									</div>
								...
								<div class="d-flex justify-content-end mb-4">
									...
									<div class="img_cont_msg">
								<img src="<%=request.getContextPath()%>/resources/images/avatar/2.jpg" class="rounded-circle user_img_msg" alt=""/>
									</div>
								</div>
								<div class="d-flex justify-content-start mb-4">
									<div class="img_cont_msg">
                        ...
                        <ul class="navbar-nav header-right">
											...
											<li>
												<div class="timeline-panel">
													<div class="media mr-2">
														<img alt="image" width="50" src="<%=request.getContextPath()%>/resources/images/avatar/1.jpg">
													</div>
                            ...
                            <li class="nav-item dropdown header-profile">
                                <a class="nav-link" href="javascript:void(0)" role="button" data-toggle="dropdown">
                                    ...
                                    <img src="<%=request.getContextPath()%>/resources/images/profile/33.jpg" width="20" alt=""/>
                                </a>
                                <div class="dropdown-menu dropdown-menu-right">
...
<!-- 			</ul> -->
            ...
            <div class="deznav-scroll">
				<ul class="metismenu" id="menu">
			      	<c:forEach items="${menuList }" var="menu">
				      		<li onclick="subMenu_go('${menu.mcode }')">
		                     	<a class="has-arrow ai-icon" aria-expanded="true">
									<i class="flaticon-381-networking ${menu.micon}"></i>
									<span class="nav-text">&nbsp;${menu.mname }</span>
								</a>
								<ul class="nav nav-pills nav-sidebar flex-column subMenuList" data-widget="treeview" role="menu" data-accordion="false" aria-expanded="false">
								</ul>
							</li>
    				</c:forEach>
					<!--샘플 대메뉴 -->
                    <li>
                    	<a class="has-arrow ai-icon" href="javascript:void()" aria-expanded="true">
							...
							<span class="nav-text">샘플</span>
						</a>
						<!--좌측 네비게이션 소메뉴 -->
                        <ul aria-expanded="false">
							<li><a href="asdasdasd.html">소메뉴1</a></li>
							<li><a href="asdasdasd.html">소메뉴2</a></li>
							<li><a href="asdasdasd.html">소메뉴3</a></li>
							<li><a href="asdasdasd.html">소메뉴4</a></li>
							<li><a href="asdasdasd.html">소메뉴5</a></li>
							<li><a href="asdasdasd.html">소메뉴6</a></li>
							
							<!--좌측 네비게이션 소소메뉴 -->
                            <li><a class="has-arrow" href="javascript:void()" aria-expanded="false">소메뉴7</a>
                                <ul aria-expanded="false">
                                    <li><a href="asdasdasd.html">소소매뉴1</a></li>
                                    <li><a href="asdasdasd.html">소소메뉴2</a></li>
                                    <li><a href="asdasdasd.html">소소메뉴3</a></li>
                                    <li><a href="asdasdasd.html">소소메뉴4</a></li>
                                    <li><a href="asdasdasd.html">소소메뉴5</a></li>
                            	</ul>
                            </li>
						</ul>
					</li>
        ...
        ***********************************-->
        ...
        <div class="content-body">
            <!-- row -->
			<div>
				<iframe name="ifr" src="" frameborder="0" style="width: 100%; min-height: 600px;"></iframe>
				<!-- 
				 <table border="1px">
				<tr>
					<th>메뉴코드</th>
